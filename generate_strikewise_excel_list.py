# ==================================================================================
# concept: generate table strikewise for all strikes for a particular expiry date
# get table when call through rest api
# table has strike price, ce value, pe value, change in ce value, change in pe value, change in ce oi, change in pe oi, change in ce ivp, change in pe ivp, change in ce iv, change in pe iv
# =================================================================================
import pandas as pd
import os
import traceback
# 2026-02-10
def generate_strikewise_excel_list(folder_path,sheet_name):
 list_file_name=[]
...
if __name__=="__main__":
  ...
  list_file_names=generate_strikewise_excel_list(output_folder_location,expiry_date)
  ...
  df_output_table=pd.DataFrame([dict_for_keys])
...
# ========================================================================================================================
    ...
    df_for_concat=pd.DataFrame([dict_for_keys])
    df_output_table=pd.concat([df_output_table,df_for_concat],ignore_index=True)
  sum_pe_Oi_change=pd.to_numeric(df_output_table["pe_change_in_oi_%"],errors="coerce").sum()
  sum_ce_oi_change=pd.to_numeric(df_output_table["ce_change_in_oi_%"],errors="coerce").sum()
  print(sum_pe_Oi_change)
  print(sum_ce_oi_change)
...
# df_output_table.to_excel(rf"C:\VikasData\KiteConnect\temp\10-02-26\insites\123.xlsx",sheet_name="strikewise_end_value")
