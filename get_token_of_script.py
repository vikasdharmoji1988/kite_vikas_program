import pandas as pd
def get_token_of_script(df_of_instrument:pd.DataFrame,script_name:str,script_symbol:str,output_name_of_column:str="instrument_token"):
...
if __name__=="__main__":
    ...
    nifty_50_token=get_token_of_script(df_excel,nifty_50_script_name,nifty_50_symbol_name)
