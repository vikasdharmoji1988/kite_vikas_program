from generate_strikewise_excel_list import generate_strikewise_excel_list
import os
import pandas as pd
import traceback
def create_df_of_last_values(input_folder_location,expiry_date): 
# output_folder_location=r"C:\VikasData\KiteConnect\temp\10-02-26\06_02_2026_09_19_28_Vs9&\output_folder"
#   expiry_date="2026-02-10"
 try:
  list_file_names=generate_strikewise_excel_list(input_folder_location,expiry_date)
  ...
  for i in list_file_names: 
    excel_path=os.path.join(input_folder_location,f"{i}.xlsx")
